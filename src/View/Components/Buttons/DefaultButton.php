...
class DefaultButton extends Component implements Button
{
    ...
    {
        return [
            'class' => 'inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest bg-gray-800 dark:bg-black hover:bg-gray-700 dark:hover:bg-gray-800 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150',
        ];
    }
